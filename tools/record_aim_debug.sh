...
# GX0 raw images are included because their header stamp is part of the timing
# path under test. This can produce a large bag.
...
ros2 interface show aim_msgs/msg/GxTimestampStatus \
  > "${META_DIR}/gx_timestamp_status_interface.txt" 2>&1 || true
